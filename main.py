...
def sendMessage(message):
    bot.send_message(message.chat.id, "Я бот утродоброе")
    ...
    # keyboard.add(types.InlineKeyboardButton(text='Выбрать фотографии для спокойной ночи', callback_data='mode:photo'))
